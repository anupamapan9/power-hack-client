        ...
        <section className='w-1/3 mx-auto mt-40'>
            <div>
                ...
                <form>
                    ...
                    <input type="submit" value="Login" class="text-white bg-green-900 hover:bg-green-800 focus:ring-4 focus:outline-none  font-medium text-sm w-full sm:w-auto px-5 py-2.5 text-center " />
                </form>
            </div>
